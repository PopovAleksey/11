...
<head>
    ...
    <title>@yield('title', 'Constructor')</title>
...
<div class="wrapper">
    ...
    @include('constructor.navbar')

    @include('constructor.left-side')
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2022 <a href="https://github.com/PopovAleksey/Page-Constructor">Oleksii
                Popov</a>.</strong>
        All rights reserved.
